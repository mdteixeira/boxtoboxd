...
function Navbar() {
  return (
    <>
      <header className="w-full flex justify-between items-center gap-1 sticky top-0 pt-2 container mx-auto bg-gradient-to-b from-slate-200 dark:from-slate-800 to-transparent">
        <div className="flex justify-between w-full items-center md:p-2 p-1 md:rounded-2xl rounded-e-2xl bg-neutral-50 dark:bg-slate-900 border dark:border-slate-800 z-10">
